  ...
  <div class="grid space-y-4">
    ...
    <div class="flex items-start justify-start mt-4 gap-8">
      ...
      <div>
        ...
        <UButton trailing-icon="i-heroicons-plus" @click.prevent="addRelation">
          Add Relation
        </UButton>
      </div>
    </div>
...
const setActivePath = async (path: string) => {
  ...
  await nextTick(() => state.value.activeMappingPath = getPath(path));
